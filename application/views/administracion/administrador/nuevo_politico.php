<div class="container">
  <div class="jumbotron">
    ...
    <p>Rellene los datos y pulse añadir.</p>
        ...
        <?php echo form_open("http://".base_url()."index.php/administrador/nuevo_politico")?>
                ...
                <div class="form-group">
                    <label for="InputName">Imágen</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="imagen" id="imagen">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <input type="submit" name="submit" id="submit" value="Añadir nuevo político" class="btn btn-info pull-right">
