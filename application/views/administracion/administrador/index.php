                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?=$NumeroPoliticos?></div>
                                    <div>Políticos</div>
                                </div>
                            </div>
                        </div>
                        <a href="http://<?=base_url()?>index.php/administrador/mostrar_politicos">
                            <div class="panel-footer">
                                <span class="pull-left">Ver detalles</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="glyphicon glyphicon-tower fa-5x"></i>
                                </div>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?=$NumeroPartidos?></div>
                                    <div>Partidos</div>
                                </div>
                            </div>
                        </div>
                        <a href="http://<?=base_url()?>index.php/administrador/mostrar_partidos">
                            <div class="panel-footer">
                                <span class="pull-left">Ver detalles</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
