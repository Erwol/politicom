    ...
    <!-- Vista para cuando tras hacer clic en votar, el usuario resulta no estar logueado -->
    <br><br><br>
        <div class="container">
            <div class="form-signin">
                <input class="btn btn-danger btn-lg btn-block" type="submit" value="Debes iniciar sesión para votar">
